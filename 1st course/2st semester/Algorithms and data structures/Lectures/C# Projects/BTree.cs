    ...
    public partial class Form1 : Form
    {
        ...
        public class TTree
        {
            ...
            private void SearchTreeN(TNode v, int level)
            {
                ...
                // DoSomethingWithNodeValue(v.Value, level); // preorder
                SearchTreeN(v.LeftTree, level + 1);
                DoSomethingWithNodeValue(v.Value, level); // inorder
                SearchTreeN(v.RightTree, level+1);
                // DoSomethingWithNodeValue(v.Value, level); // postorder
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            /*                        
                ...
                my_tree.AddNode(2, in_right, 13);
                my_tree.AddNode(3, in_left, 4);
                my_tree.AddNode(3, in_right, 15);
                my_tree.AddNode(4, in_left, 20);
                my_tree.AddNode(4, in_right, 7);
            
                my_tree.SearchTree(textBox1);
            */
